...
var PAGES = [
  {
    ...
    replacements: [
      ...
      {find: '<div class="funnel-txt">Envie d\'aller plus loin ? L\'espace <b style="color:var(--amber);">OUTILS</b> ajoute l\'avantage statistique, la mise conseillée et les alertes cotes sur chaque marché.</div>', build: function(d){ return '<div class="funnel-txt">' + d.markets_page.funnel_banner_text + '</div>'; }},
      {find: '<a href="/pro.html" class="funnel-cta">DÉCOUVRIR OUTILS →</a>', build: function(d){ return '<a href="/pro.html" class="funnel-cta">' + d.cta.discover_tools + '</a>'; }},
  ...
  },
  {
    ...
    replacements: [
      ...
      {find: "<a class=\"pw-cta\" href=\"/pro.html\">PASSER OUTILS — 19,95€/MOIS →</a>", build: function(d, l, esc){ return "<a class=\"pw-cta\" href=\"/pro.html\">" + esc(d.tools_page.pw_cta) + "</a>"; }},

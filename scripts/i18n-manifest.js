...
var PAGES = [
  ...
  },
  {
    ...
    replacements: [
      ...
      {find: "Voir les résultats d'hier", build: function(d,l){ return HOME_V4[l].cta2; }},
      {find: "Voir un exemple d'analyse", build: function(d,l){ return HOME_V4[l].cta3; }},
      ...
      {find: 'IASHARK transforme les statistiques des deux équipes en une probabilité claire, expliquée et comparée à la cote.', build: function(d,l){ return HOME_V2[l].sub; }},

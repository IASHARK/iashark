...
// Correction de statut (2026-09-05, retour Phase 3A) : DEUX questions
// distinctes, jamais confondues.
//   - READINESS_GATE_IMPLEMENTATION : le CODE du gate (checkReadinessGate
//     ci-dessous) est-il correctement implemente et teste ? Constante
//     statique, ne dit RIEN sur l'etat reel des donnees.
//   - DATA_READINESS (calculee par checkReadinessGate(...).ready) :
//     les VRAIES donnees actuellement collectees satisfont-elles les
//     seuils ? Au 2026-09-05 : nSettledFixtures~12 vs minimum 300 ->
//     FALSE. Ne jamais afficher "READINESS_GATE = PASS" seul : cette
//     ambiguite a ete explicitement signalee et corrigee - toujours
//     rapporter les deux valeurs separement.
const READINESS_GATE_IMPLEMENTATION = "PASS";

// input = { nSettledFixtures, nCompleteMarketObservations, nCalendarPeriods }
// - une famille de marche a la fois (1X2, BTTS, FT_TOTAL_2.5, ...).
// Le champ `ready` de la sortie EST la valeur DATA_READINESS reelle -
// jamais a confondre avec READINESS_GATE_IMPLEMENTATION ci-dessus.

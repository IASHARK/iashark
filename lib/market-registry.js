...
const MARKET_REGISTRY = [
  ...
  },
  {
    ...
    resolver_function: "lib/resolvers.js#resolveMarketWin (Total Domicile/Exterieur Over/Under)",
    min_data_quality: "low",
    availability_status: "MODELLED_EXPERIMENTAL",
    version: "v1",
    notes: "Branché en production dans le pipeline le 2026-08-31 (allMarkets, cotes réelles 'Total - Home'/'Total - Away' déjà présentes dans /odds?fixture=X, jamais fetchées avant). Resolver réel écrit et testé. MODELLED_EXPERIMENTAL tant qu'aucun backtest hors échantillon n'a été exécuté (aucun ne l'a été à ce jour, comme pour tout le reste du catalogue).",
  },
  {
    id: "BTTS",
    category: "GOALS",
  ...
  },
  {
    ...
    resolver_function: "lib/resolvers.js#resolveMarketWin (Clean Sheet Domicile/Exterieur)",
    min_data_quality: "low",
    availability_status: "MODELLED_EXPERIMENTAL",
    version: "v1",
    notes: "Branché en production le 2026-08-31 (allMarkets, cotes réelles 'Clean Sheet - Home/Away'). Resolver réel écrit et testé. MODELLED_EXPERIMENTAL tant qu'aucun backtest hors échantillon n'a été exécuté.",
  },
  {
    id: "WIN_TO_NIL",
    category: "GOALS",
    ...
    resolver_function: "lib/resolvers.js#resolveMarketWin (Gagne Sans Encaisser Domicile/Exterieur)",
    min_data_quality: "low",
    availability_status: "MODELLED_EXPERIMENTAL",
    version: "v1",
    notes: "Branché en production le 2026-08-31 (allMarkets, cote réelle 'Win To Nil'). Resolver réel écrit et testé - distinct du clean sheet seul (exige aussi la victoire). MODELLED_EXPERIMENTAL tant qu'aucun backtest hors échantillon n'a été exécuté.",
  },
  {
    id: "RESULT_AND_TOTAL_GOALS",
    category: "COMBO",
    label_fr: "Résultat + total de buts (ex: victoire domicile & plus de 2,5 buts)",
    required_inputs: ["lambdaHome", "lambdaAway"],
    model_function: "lib/markets/score-matrix.js#deriveMarketsFromMatrix (resultAndOver25/resultAndUnder25 - joint réel cellule par cellule, jamais une multiplication naive des probabilités marginales)",
    resolver_function: "lib/resolvers.js#resolveMarketWin (marchés combinés, séparateur '&')",
    min_data_quality: "low",
    availability_status: "MODELLED_EXPERIMENTAL",
    version: "v1",
    notes: "Ajouté le 2026-08-31, demande explicite de l'utilisateur. Bet type bookmaker réellement observé : 'Result/Total Goals' (bet_id 25, 5 bookmakers, fréquence 100% sur les 30 fixtures test des 13 ligues). Uniquement la ligne 2.5 (la plus liquide) - pas les 7 lignes complètes. MODELLED_EXPERIMENTAL tant qu'aucun backtest hors échantillon n'a été exécuté.",
  },
  {
    id: "RESULT_AND_BTTS",
    category: "COMBO",
    label_fr: "Résultat + BTTS (ex: victoire extérieur & les deux marquent)",
    required_inputs: ["lambdaHome", "lambdaAway"],
    model_function: "lib/markets/score-matrix.js#deriveMarketsFromMatrix (resultAndBtts/resultAndNoBtts - joint réel cellule par cellule)",
    resolver_function: "lib/resolvers.js#resolveMarketWin (marchés combinés, séparateur '&')",
    min_data_quality: "low",
    availability_status: "MODELLED_EXPERIMENTAL",
    version: "v1",
    notes: "Ajouté le 2026-08-31, demande explicite de l'utilisateur. Bet type bookmaker réellement observé : 'Results/Both Teams Score' (bet_id 24, 4 bookmakers, fréquence 100%). MODELLED_EXPERIMENTAL tant qu'aucun backtest hors échantillon n'a été exécuté.",
  },
  {
    id: "EXACT_SCORE",
    category: "GOALS",

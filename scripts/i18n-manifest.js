...
var HOME_V2 = {
  fr:{matches:'Matchs',markets:'Marchés',method:'Méthode',guides:'Guides',start:'Commencer',eyebrow:"L'ANALYSE SPORTIVE, SANS LE BRUIT",title1:'Comprenez le match.',title2:'Identifiez le marché juste.',sub:'IASHARK transforme des millions de données sportives en une décision claire, expliquée et mesurable.',discover:'Découvrir la méthode',updated:'Données actualisées',multi:'Analyse multi-facteurs',explained:'Décision expliquée',featureLoading:'SÉLECTION DU MATCH À SUIVRE…',decisions:'Les décisions du jour',decisionsSub:'Un marché prioritaire par match, choisi selon la convergence des données.',recommended:'MARCHÉ RECOMMANDÉ',modelConfidence:"Confiance de l'analyse",reading:'Lecture IASHARK',priority:'Prioritaire',recent:'Forme récente',advanced:'Données avancées',context:'Contexte du match',insight:"Ouvrez l'analyse pour voir les facteurs, limites et risques de cette sélection.",confidence:'CONFIANCE',preliminary:'Analyse préliminaire',view:'Voir l\'analyse →',locked:'Analyse réservée aux membres Pro',upgrade:'Deviens Pro →',today:"Aujourd'hui",noHero:'AUCUN MATCH DISPONIBLE',noOtherToday:'AUCUN AUTRE MATCH TROUVÉ',noOtherTomorrow:'AUCUN AUTRE MATCH DEMAIN',otherLeague:'Essaie un autre championnat.',priceMonth:"/mois",priceNote:"Sans engagement · résiliable en un clic",freeFeatAll:"Tous les matchs du jour visibles",proFeatTools:"Les outils Pro : scanner de value, combiné, simulateur",tomorrow:"Demain",badgeLeagues:"15 compétitions",badgeRest:"analyse publiée avant le coup d'envoi",statLeagues:"Compétitions couvertes",statModels:"Modèles statistiques",statFree:"Analyse offerte par jour"},
  en:{matches:'Matches',markets:'Markets',method:'Method',guides:'Guides',start:'Get started',eyebrow:'SPORTS ANALYSIS, WITHOUT THE NOISE',title1:'Understand the match.',title2:'Find the right market.',sub:'IASHARK turns millions of sports data points into one clear, explained and measurable decision.',discover:'Discover the method',updated:'Updated data',multi:'Multi-factor analysis',explained:'Explained decision',featureLoading:'SELECTING THE MATCH TO WATCH…',decisions:"Today's decisions",decisionsSub:'One priority market per match, selected when the data converges.',recommended:'RECOMMENDED MARKET',modelConfidence:'Analysis confidence',reading:'IASHARK reading',priority:'Priority',recent:'Recent form',advanced:'Advanced data',context:'Match context',insight:'Open the analysis to see the factors, limitations and risks behind this selection.',confidence:'CONFIDENCE',preliminary:'Preliminary analysis',view:'View analysis →',locked:'Analysis reserved for Pro members',upgrade:'Go Pro →',today:'Today',noHero:'NO MATCH AVAILABLE',noOtherToday:'NO OTHER MATCH FOUND',noOtherTomorrow:'NO OTHER MATCH TOMORROW',otherLeague:'Try another competition.',priceMonth:"/month",priceNote:"No commitment · cancel in one click",freeFeatAll:"Every match of the day, visible",proFeatTools:"Pro tools: value scanner, accumulator, simulator",tomorrow:"Tomorrow",badgeLeagues:"15 competitions",badgeRest:"analysis published before kick-off",statLeagues:"Competitions covered",statModels:"Statistical models",statFree:"Free analysis per day"},
  es:{matches:'Partidos',markets:'Mercados',method:'Método',guides:'Guías',start:'Empezar',eyebrow:'ANÁLISIS DEPORTIVO, SIN RUIDO',title1:'Entiende el partido.',title2:'Encuentra el mercado adecuado.',sub:'IASHARK transforma millones de datos deportivos en una decisión clara, explicada y medible.',discover:'Descubrir el método',updated:'Datos actualizados',multi:'Análisis multifactorial',explained:'Decisión explicada',featureLoading:'SELECCIONANDO EL PARTIDO DESTACADO…',decisions:'Las decisiones del día',decisionsSub:'Un mercado prioritario por partido, elegido cuando convergen los datos.',recommended:'MERCADO RECOMENDADO',modelConfidence:'Confianza del análisis',reading:'Lectura IASHARK',priority:'Prioritario',recent:'Forma reciente',advanced:'Datos avanzados',context:'Contexto del partido',insight:'Abre el análisis para ver los factores, límites y riesgos de esta selección.',confidence:'CONFIANZA',preliminary:'Análisis preliminar',view:'Ver análisis →',today:'Hoy',noHero:'NINGÚN PARTIDO DISPONIBLE',noOtherToday:'NO SE ENCONTRARON MÁS PARTIDOS',noOtherTomorrow:'NO HAY OTRO PARTIDO MAÑANA',otherLeague:'Prueba otra competición.',priceMonth:"/mes",priceNote:"Sin compromiso · cancela en un clic",freeFeatAll:"Todos los partidos del día, visibles",proFeatTools:"Herramientas Pro: escáner de value, combinada, simulador",tomorrow:"Mañana",badgeLeagues:"15 competiciones",badgeRest:"análisis publicado antes del inicio",statLeagues:"Competiciones cubiertas",statModels:"Modelos estadísticos",statFree:"Análisis gratis al día"},
  de:{matches:'Spiele',markets:'Märkte',method:'Methode',guides:'Guides',start:'Starten',eyebrow:'SPORTANALYSE, OHNE ABLENKUNG',title1:'Verstehe das Spiel.',title2:'Finde den richtigen Markt.',sub:'IASHARK verwandelt Millionen von Sportdaten in eine klare, erklärte und messbare Entscheidung.',discover:'Methode entdecken',updated:'Aktuelle Daten',multi:'Multifaktor-Analyse',explained:'Erklärte Entscheidung',featureLoading:'TOPSPIEL WIRD AUSGEWÄHLT…',decisions:'Die Entscheidungen des Tages',decisionsSub:'Ein vorrangiger Markt pro Spiel, ausgewählt wenn die Daten übereinstimmen.',recommended:'EMPFOHLENER MARKT',modelConfidence:'Analysevertrauen',reading:'IASHARK Einschätzung',priority:'Prioritär',recent:'Aktuelle Form',advanced:'Erweiterte Daten',context:'Spielkontext',insight:'Öffne die Analyse, um Faktoren, Grenzen und Risiken dieser Auswahl zu sehen.',confidence:'KONFIDENZ',preliminary:'Vorläufige Analyse',view:'Analyse ansehen →',today:'Heute',noHero:'KEIN SPIEL VERFÜGBAR',noOtherToday:'KEIN WEITERES SPIEL GEFUNDEN',noOtherTomorrow:'MORGEN KEIN WEITERES SPIEL',otherLeague:'Versuche einen anderen Wettbewerb.',priceMonth:"/Monat",priceNote:"Keine Bindung · Kündigung mit einem Klick",freeFeatAll:"Alle Spiele des Tages sichtbar",proFeatTools:"Pro-Tools: Value-Scanner, Kombiwette, Simulator",tomorrow:"Morgen",badgeLeagues:"15 Wettbewerbe",badgeRest:"Analyse vor dem Anpfiff veröffentlicht",statLeagues:"Abgedeckte Wettbewerbe",statModels:"Statistische Modelle",statFree:"Gratis-Analyse pro Tag"},
  it:{matches:'Partite',markets:'Mercati',method:'Metodo',guides:'Guide',start:'Inizia',eyebrow:'ANALISI SPORTIVA, SENZA RUMORE',title1:'Comprendi la partita.',title2:'Trova il mercato giusto.',sub:'IASHARK trasforma milioni di dati sportivi in una decisione chiara, spiegata e misurabile.',discover:'Scopri il metodo',updated:'Dati aggiornati',multi:'Analisi multifattoriale',explained:'Decisione spiegata',featureLoading:'SELEZIONE DEL MATCH DA SEGUIRE…',decisions:'Le decisioni del giorno',decisionsSub:'Un mercato prioritario per partita, scelto quando i dati convergono.',recommended:'MERCATO CONSIGLIATO',modelConfidence:"Affidabilità dell'analisi",reading:'Lettura IASHARK',priority:'Prioritario',recent:'Forma recente',advanced:'Dati avanzati',context:'Contesto partita',insight:"Apri l'analisi per vedere fattori, limiti e rischi di questa selezione.",confidence:'FIDUCIA',preliminary:'Analisi preliminare',view:"Vedi l'analisi →",today:'Oggi',noHero:'NESSUNA PARTITA DISPONIBILE',noOtherToday:'NESSUN ALTRO MATCH TROVATO',noOtherTomorrow:'NESSUN ALTRO MATCH DOMANI',otherLeague:"Prova un'altra competizione.",priceMonth:"/mese",priceNote:"Nessun vincolo · disdici con un clic",freeFeatAll:"Tutte le partite del giorno, visibili",proFeatTools:"Strumenti Pro: scanner di value, multipla, simulatore",tomorrow:"Domani",badgeLeagues:"15 competizioni",badgeRest:"analisi pubblicata prima del fischio d'inizio",statLeagues:"Competizioni coperte",statModels:"Modelli statistici",statFree:"Analisi gratuita al giorno"},
  pt:{matches:'Jogos',markets:'Mercados',method:'Método',guides:'Guias',start:'Começar',eyebrow:'ANÁLISE DESPORTIVA, SEM RUÍDO',title1:'Compreenda o jogo.',title2:'Encontre o mercado certo.',sub:'A IASHARK transforma milhões de dados desportivos numa decisão clara, explicada e mensurável.',discover:'Descobrir o método',updated:'Dados atualizados',multi:'Análise multifatorial',explained:'Decisão explicada',featureLoading:'A SELECIONAR O JOGO EM DESTAQUE…',decisions:'As decisões do dia',decisionsSub:'Um mercado prioritário por jogo, escolhido quando os dados convergem.',recommended:'MERCADO RECOMENDADO',modelConfidence:'Confiança da análise',reading:'Leitura IASHARK',priority:'Prioritário',recent:'Forma recente',advanced:'Dados avançados',context:'Contexto do jogo',insight:'Abra a análise para ver os fatores, limites e riscos desta seleção.',confidence:'CONFIANÇA',preliminary:'Análise preliminar',view:'Ver análise →',today:'Hoje',noHero:'NENHUM JOGO DISPONÍVEL',noOtherToday:'NENHUM OUTRO JOGO ENCONTRADO',noOtherTomorrow:'NENHUM OUTRO JOGO AMANHÃ',otherLeague:'Experimente outra competição.',priceMonth:"/mês",priceNote:"Sem compromisso · cancele num clique",freeFeatAll:"Todos os jogos do dia, visíveis",proFeatTools:"Ferramentas Pro: scanner de value, múltipla, simulador",tomorrow:"Amanhã",badgeLeagues:"15 competições",badgeRest:"análise publicada antes do apito inicial",statLeagues:"Competições cobertas",statModels:"Modelos estatísticos",statFree:"Análise grátis por dia"}
};

var HOME_V3 = {"fr": {"railLbl": "15 COMPÉTITIONS COUVERTES", "anaLbl": "CE QUE TU REÇOIS", "anaT1": "Une analyse, ", "anaT2": "pas un pronostic", "anaT3": " balancé sans explication.", "c1t": "Le signal", "c1d": "Le marché retenu, sa probabilité selon le modèle, celle du marché, et l’écart entre les deux — affiché même quand il est défavorable.", "c2t": "Notre lecture du match", "c2d": "Ce que le modèle a vu, écrit en français, avec le facteur qui a fait pencher la décision.", "c3t": "Ce que dit le modèle", "c3d": "Buts attendus par équipe et scores les plus probables, en clair.", "c4t": "Comparatif des deux équipes", "c4d": "Tirs, tirs cadrés, possession, corners — avec les lignes qui pèsent sur le marché recommandé mises en avant.", "c5t": "Scénario probable", "c5d": "La probabilité de but tranche de 15 minutes par tranche de 15 minutes.", "c6t": "Les limites", "c6d": "Les stats à ne pas surinterpréter, et ce que la donnée ne permet pas d’affirmer.", "trLbl": "CE QU’ON NE FERA PAS", "trT1": "On préfère te dire ", "trT2": "quand on ne sait pas.", "t1t": "Aucune promesse de gain", "t1d": "Le pari reste un pari. On calcule des probabilités, on ne garantit aucun résultat.", "t2t": "L’écart s’affiche même quand il te dessert", "t2d": "Si la cote proposée est moins intéressante que notre estimation, c’est écrit noir sur blanc.", "t3t": "Une analyse n’est jamais réécrite après le match", "t3d": "Elle est publiée avant le coup d’envoi et reste telle quelle, résultat ou pas.", "t4t": "Aucun signal forcé", "t4d": "Quand aucun marché ne franchit nos seuils, on l’écrit plutôt que d’inventer un pari.", "faqLbl": "QUESTIONS FRÉQUENTES", "faqT1": "Ce que tu te demandes ", "faqT2": "avant de payer.", "q1": "Je peux essayer avant de payer ?", "a1": "Oui. Une analyse complète est offerte chaque jour avec un compte gratuit, sans carte bancaire. Tu vois exactement ce que reçoit un abonné.", "q2": "Je vais gagner de l’argent ?", "a2": "Personne ne peut te le promettre, et on ne le fera pas. Le modèle cherche les marchés où la probabilité calculée s’écarte de celle du marché. C’est une méthode, pas une garantie.", "q3": "Je peux résilier quand je veux ?", "a3": "Oui, en un clic depuis ton compte. Sans engagement, sans préavis, sans justification.", "q4": "D’où viennent les données ?", "a4": "Des données officielles de match : compositions, historiques de confrontation, statistiques de tirs et de buts attendus, et les cotes réelles des bookmakers.", "q5": "Combien de matchs par jour ?", "a5": "Tous les matchs des 15 compétitions couvertes. Le nombre varie selon le calendrier — tu vois la liste complète du jour sur cette page."}, "en": {"railLbl": "15 COMPETITIONS COVERED", "anaLbl": "WHAT YOU GET", "anaT1": "An analysis, ", "anaT2": "not a tip", "anaT3": " thrown at you with no explanation.", "c1t": "The signal", "c1d": "The selected market, its model probability, the market's, and the gap between them — shown even when it works against you.", "c2t": "Our read on the match", "c2d": "What the model saw, in plain words, with the factor that tipped the decision.", "c3t": "What the model says", "c3d": "Expected goals per team and the most likely scorelines, in plain view.", "c4t": "Head-to-head comparison", "c4d": "Shots, shots on target, possession, corners — with the rows that drive the recommended market highlighted.", "c5t": "Likely scenario", "c5d": "Goal probability, fifteen minutes at a time.", "c6t": "The limits", "c6d": "The stats not to over-read, and what the data simply cannot claim.", "trLbl": "WHAT WE WON'T DO", "trT1": "We'd rather tell you ", "trT2": "when we don't know.", "t1t": "No promise of profit", "t1d": "A bet stays a bet. We compute probabilities; we guarantee no outcome.", "t2t": "The gap shows even when it hurts you", "t2d": "If the offered odds are worse than our estimate, we say so in black and white.", "t3t": "An analysis is never rewritten after the match", "t3d": "It is published before kick-off and stays exactly as it was, win or lose.", "t4t": "No forced signal", "t4d": "When no market clears our thresholds, we say so instead of inventing a bet.", "faqLbl": "FREQUENTLY ASKED", "faqT1": "What you're wondering ", "faqT2": "before you pay.", "q1": "Can I try before paying?", "a1": "Yes. One full analysis is free every day with a free account, no card required. You see exactly what a subscriber gets.", "q2": "Will I make money?", "a2": "Nobody can promise you that, and we won't. The model looks for markets where the computed probability diverges from the market's. It is a method, not a guarantee.", "q3": "Can I cancel any time?", "a3": "Yes, in one click from your account. No commitment, no notice, no reason needed.", "q4": "Where does the data come from?", "a4": "From official match data: line-ups, head-to-head history, shot and expected-goals statistics, and real bookmaker odds.", "q5": "How many matches per day?", "a5": "Every match across the 15 competitions we cover. The count varies with the fixture list — you see today's full list on this page."}, "es": {"railLbl": "15 COMPETICIONES CUBIERTAS", "anaLbl": "LO QUE RECIBES", "anaT1": "Un análisis, ", "anaT2": "no un pronóstico", "anaT3": " lanzado sin explicación.", "c1t": "La señal", "c1d": "El mercado elegido, su probabilidad según el modelo, la del mercado y la diferencia entre ambas — mostrada incluso cuando te perjudica.", "c2t": "Nuestra lectura del partido", "c2d": "Lo que vio el modelo, en lenguaje claro, con el factor que inclinó la decisión.", "c3t": "Lo que dice el modelo", "c3d": "Goles esperados por equipo y los marcadores más probables, a la vista.", "c4t": "Comparativa de los dos equipos", "c4d": "Tiros, tiros a puerta, posesión, córners — con las líneas que pesan en el mercado recomendado destacadas.", "c5t": "Escenario probable", "c5d": "La probabilidad de gol, tramo de 15 minutos a tramo de 15 minutos.", "c6t": "Los límites", "c6d": "Las estadísticas que no hay que sobreinterpretar, y lo que el dato no permite afirmar.", "trLbl": "LO QUE NO HAREMOS", "trT1": "Preferimos decirte ", "trT2": "cuando no lo sabemos.", "t1t": "Ninguna promesa de ganancia", "t1d": "Una apuesta sigue siendo una apuesta. Calculamos probabilidades, no garantizamos ningún resultado.", "t2t": "La diferencia se muestra aunque te perjudique", "t2d": "Si la cuota ofrecida es peor que nuestra estimación, está escrito negro sobre blanco.", "t3t": "Un análisis nunca se reescribe tras el partido", "t3d": "Se publica antes del inicio y queda tal cual, gane o pierda.", "t4t": "Ninguna señal forzada", "t4d": "Cuando ningún mercado supera nuestros umbrales, lo decimos en vez de inventar una apuesta.", "faqLbl": "PREGUNTAS FRECUENTES", "faqT1": "Lo que te preguntas ", "faqT2": "antes de pagar.", "q1": "¿Puedo probar antes de pagar?", "a1": "Sí. Un análisis completo gratis cada día con una cuenta gratuita, sin tarjeta. Ves exactamente lo que recibe un suscriptor.", "q2": "¿Voy a ganar dinero?", "a2": "Nadie puede prometértelo, y nosotros no lo haremos. El modelo busca mercados donde la probabilidad calculada se aparta de la del mercado. Es un método, no una garantía.", "q3": "¿Puedo cancelar cuando quiera?", "a3": "Sí, en un clic desde tu cuenta. Sin compromiso, sin preaviso, sin justificación.", "q4": "¿De dónde vienen los datos?", "a4": "De datos oficiales de partido: alineaciones, historial de enfrentamientos, estadísticas de tiros y goles esperados, y las cuotas reales de las casas.", "q5": "¿Cuántos partidos al día?", "a5": "Todos los partidos de las 15 competiciones cubiertas. El número varía según el calendario — ves la lista completa del día en esta página."}, "de": {"railLbl": "15 WETTBEWERBE ABGEDECKT", "anaLbl": "WAS DU BEKOMMST", "anaT1": "Eine Analyse, ", "anaT2": "kein Tipp", "anaT3": " ohne jede Erklärung.", "c1t": "Das Signal", "c1d": "Der gewählte Markt, seine Modellwahrscheinlichkeit, die des Marktes und die Abweichung — auch wenn sie gegen dich spricht.", "c2t": "Unsere Einschätzung des Spiels", "c2d": "Was das Modell gesehen hat, in klaren Worten, mit dem ausschlaggebenden Faktor.", "c3t": "Was das Modell sagt", "c3d": "Erwartete Tore pro Team und die wahrscheinlichsten Ergebnisse, klar dargestellt.", "c4t": "Vergleich beider Teams", "c4d": "Schüsse, Schüsse aufs Tor, Ballbesitz, Ecken — mit hervorgehobenen Zeilen, die den empfohlenen Markt bestimmen.", "c5t": "Wahrscheinliches Szenario", "c5d": "Die Torwahrscheinlichkeit, 15-Minuten-Abschnitt für 15-Minuten-Abschnitt.", "c6t": "Die Grenzen", "c6d": "Die Statistiken, die man nicht überbewerten sollte, und was die Daten nicht hergeben.", "trLbl": "WAS WIR NICHT TUN", "trT1": "Wir sagen dir lieber, ", "trT2": "wann wir es nicht wissen.", "t1t": "Kein Gewinnversprechen", "t1d": "Eine Wette bleibt eine Wette. Wir berechnen Wahrscheinlichkeiten, garantieren aber kein Ergebnis.", "t2t": "Die Abweichung wird auch dann gezeigt, wenn sie gegen dich spricht", "t2d": "Ist die angebotene Quote schlechter als unsere Schätzung, steht das schwarz auf weiß da.", "t3t": "Eine Analyse wird nach dem Spiel nie umgeschrieben", "t3d": "Sie erscheint vor dem Anpfiff und bleibt unverändert, egal wie es ausgeht.", "t4t": "Kein erzwungenes Signal", "t4d": "Wenn kein Markt unsere Schwellen erreicht, sagen wir das, statt eine Wette zu erfinden.", "faqLbl": "HÄUFIGE FRAGEN", "faqT1": "Was du dich fragst, ", "faqT2": "bevor du zahlst.", "q1": "Kann ich vor dem Kauf testen?", "a1": "Ja. Eine vollständige Analyse ist täglich gratis, mit kostenlosem Konto und ohne Karte. Du siehst genau, was ein Abonnent bekommt.", "q2": "Werde ich Geld verdienen?", "a2": "Das kann dir niemand versprechen, und wir tun es nicht. Das Modell sucht Märkte, in denen die berechnete Wahrscheinlichkeit von der des Marktes abweicht. Eine Methode, keine Garantie.", "q3": "Kann ich jederzeit kündigen?", "a3": "Ja, mit einem Klick in deinem Konto. Ohne Bindung, ohne Frist, ohne Begründung.", "q4": "Woher kommen die Daten?", "a4": "Aus offiziellen Spieldaten: Aufstellungen, Direktvergleiche, Schuss- und Expected-Goals-Statistiken sowie echte Buchmacherquoten.", "q5": "Wie viele Spiele pro Tag?", "a5": "Alle Spiele der 15 abgedeckten Wettbewerbe. Die Zahl hängt vom Spielplan ab — die vollständige Tagesliste siehst du auf dieser Seite."}, "it": {"railLbl": "15 COMPETIZIONI COPERTE", "anaLbl": "COSA RICEVI", "anaT1": "Un'analisi, ", "anaT2": "non un pronostico", "anaT3": " buttato lì senza spiegazioni.", "c1t": "Il segnale", "c1d": "Il mercato scelto, la sua probabilità secondo il modello, quella del mercato e lo scarto — mostrato anche quando è sfavorevole.", "c2t": "La nostra lettura della partita", "c2d": "Ciò che il modello ha visto, in parole chiare, con il fattore decisivo.", "c3t": "Cosa dice il modello", "c3d": "Gol attesi per squadra e i risultati più probabili, in chiaro.", "c4t": "Confronto tra le due squadre", "c4d": "Tiri, tiri in porta, possesso, calci d'angolo — con in evidenza le righe che pesano sul mercato consigliato.", "c5t": "Scenario probabile", "c5d": "La probabilità di gol, blocco di 15 minuti dopo blocco di 15 minuti.", "c6t": "I limiti", "c6d": "Le statistiche da non sopravvalutare, e ciò che il dato non permette di affermare.", "trLbl": "COSA NON FAREMO", "trT1": "Preferiamo dirti ", "trT2": "quando non lo sappiamo.", "t1t": "Nessuna promessa di guadagno", "t1d": "Una scommessa resta una scommessa. Calcoliamo probabilità, non garantiamo alcun risultato.", "t2t": "Lo scarto si vede anche quando ti penalizza", "t2d": "Se la quota proposta è peggiore della nostra stima, lo scriviamo nero su bianco.", "t3t": "Un'analisi non viene mai riscritta dopo la partita", "t3d": "Viene pubblicata prima del fischio d'inizio e resta tale, comunque vada.", "t4t": "Nessun segnale forzato", "t4d": "Quando nessun mercato supera le nostre soglie, lo scriviamo invece di inventare una scommessa.", "faqLbl": "DOMANDE FREQUENTI", "faqT1": "Quello che ti chiedi ", "faqT2": "prima di pagare.", "q1": "Posso provare prima di pagare?", "a1": "Sì. Un'analisi completa è offerta ogni giorno con un account gratuito, senza carta. Vedi esattamente ciò che riceve un abbonato.", "q2": "Guadagnerò dei soldi?", "a2": "Nessuno può promettertelo, e noi non lo faremo. Il modello cerca i mercati in cui la probabilità calcolata si discosta da quella del mercato. È un metodo, non una garanzia.", "q3": "Posso disdire quando voglio?", "a3": "Sì, con un clic dal tuo account. Senza vincoli, senza preavviso, senza giustificazioni.", "q4": "Da dove vengono i dati?", "a4": "Da dati ufficiali delle partite: formazioni, storico dei confronti, statistiche di tiri e gol attesi, e le quote reali dei bookmaker.", "q5": "Quante partite al giorno?", "a5": "Tutte le partite delle 15 competizioni coperte. Il numero varia col calendario — vedi l'elenco completo del giorno in questa pagina."}, "pt": {"railLbl": "15 COMPETIÇÕES COBERTAS", "anaLbl": "O QUE RECEBES", "anaT1": "Uma análise, ", "anaT2": "não um palpite", "anaT3": " atirado sem explicação.", "c1t": "O sinal", "c1d": "O mercado escolhido, a sua probabilidade segundo o modelo, a do mercado e a diferença — mostrada mesmo quando te desfavorece.", "c2t": "A nossa leitura do jogo", "c2d": "O que o modelo viu, em linguagem clara, com o fator que decidiu.", "c3t": "O que diz o modelo", "c3d": "Golos esperados por equipa e os resultados mais prováveis, à vista.", "c4t": "Comparação das duas equipas", "c4d": "Remates, remates à baliza, posse, cantos — com as linhas que pesam no mercado recomendado destacadas.", "c5t": "Cenário provável", "c5d": "A probabilidade de golo, faixa de 15 minutos a faixa de 15 minutos.", "c6t": "Os limites", "c6d": "As estatísticas a não sobre-interpretar, e o que os dados não permitem afirmar.", "trLbl": "O QUE NÃO FAREMOS", "trT1": "Preferimos dizer-te ", "trT2": "quando não sabemos.", "t1t": "Nenhuma promessa de ganho", "t1d": "Uma aposta continua a ser uma aposta. Calculamos probabilidades, não garantimos resultados.", "t2t": "A diferença aparece mesmo quando te prejudica", "t2d": "Se a odd proposta for pior do que a nossa estimativa, está escrito preto no branco.", "t3t": "Uma análise nunca é reescrita depois do jogo", "t3d": "É publicada antes do apito inicial e fica tal como está, ganhe ou perca.", "t4t": "Nenhum sinal forçado", "t4d": "Quando nenhum mercado passa os nossos limiares, dizemo-lo em vez de inventar uma aposta.", "faqLbl": "PERGUNTAS FREQUENTES", "faqT1": "O que te perguntas ", "faqT2": "antes de pagares.", "q1": "Posso experimentar antes de pagar?", "a1": "Sim. Uma análise completa é oferecida todos os dias com uma conta gratuita, sem cartão. Vês exatamente o que recebe um assinante.", "q2": "Vou ganhar dinheiro?", "a2": "Ninguém te pode prometer isso, e nós não o faremos. O modelo procura mercados onde a probabilidade calculada se afasta da do mercado. É um método, não uma garantia.", "q3": "Posso cancelar quando quiser?", "a3": "Sim, num clique a partir da tua conta. Sem compromisso, sem aviso prévio, sem justificação.", "q4": "De onde vêm os dados?", "a4": "De dados oficiais de jogo: alinhamentos, histórico de confrontos, estatísticas de remates e golos esperados, e as odds reais das casas.", "q5": "Quantos jogos por dia?", "a5": "Todos os jogos das 15 competições cobertas. O número varia com o calendário — vês a lista completa do dia nesta página."}};

var HOME_V4 = {"fr": {"t2": "Identifiez le marché ", "t3": "juste.", "cta1": "Voir l'analyse gratuite du jour", "cta2": "Voir un exemple d'analyse", "price": "Essayer gratuitement · Pro à 19,95 € par mois, sans engagement", "decSub": "Les matchs présentant aujourd’hui un écart exploitable entre le modèle et le marché.", "b1t": "text-ink\">Le signal</h3>", "b1d": "Le marché où le modèle détecte l’écart le plus intéressant avec le prix affiché par les bookmakers.", "b2t": "L’explication", "b2d": "Les données et les facteurs qui ont conduit le modèle à cette conclusion, écrits en clair.", "b3t": "L’incertitude", "b3d": "Quand les données ne sont pas assez solides, aucun signal n’est publié. C’est écrit, pas caché.", "kpiEye": "CE QUE LE MOTEUR A DÉJÀ TRAITÉ", "kpi1": "Analyses publiées", "kpi3": "Modèles croisés", "kpi4": "Matchs analysés aujourd’hui", "trLead": "Un modèle qui trouve un signal sur tous les matchs ne cherche pas un signal : il en fabrique un.", "acc3": "quand tu veux tout voir.", "pfName": "text-soft\">Gratuit</h3>", "pfDesc": "Pour juger le produit sur pièce : compte gratuit, sans carte bancaire.", "pfCta": "[0.05]\">Commencer</a>", "ff1": "Analyse gratuite du jour, complète, avec un compte gratuit", "ff2": "Marché identifié et niveau de confiance", "ff3": "Explication détaillée du signal", "pMonth": "/mois", "pNote": "Sans engagement · résiliable en un clic", "pCta": "Débloquer Pro", "pPlus": "Tout le plan Gratuit, plus :", "mTitle3": "par match.", "mLead": "Chaque modèle répond à une question différente. Le signal ne sort que là où leurs réponses convergent.", "m1d": "Distribution du nombre de buts attendus pour chaque équipe.", "m2d": "Correction des scores faibles que le Poisson pur sous-estime.", "m3d": "Des milliers de simulations pour une distribution robuste.", "m4d": "Force réelle dans le temps, et retrait du biais des cotes.", "sigT": "Signal IASHARK", "sigD": "Un marché prioritaire, une probabilité, et l’écart mesuré avec le prix du marché.", "s1d": "Calendriers, compositions probables, confrontations et statistiques xG, championnat par championnat.", "s2t": "Les modèles calculent", "s2d": "Poisson, Dixon-Coles et Monte Carlo tournent en parallèle sur chaque marché.", "s3d": "Une fiche claire : probabilité, fiabilité, et l’écart détecté avec le marché réel.", "q2": "Est-ce que IASHARK garantit des gains ?", "a2": "Non, et personne ne le peut. Le modèle cherche les marchés où la probabilité calculée s’écarte de celle du marché. C’est une méthode, pas une garantie.", "q3": "Comment le signal est-il calculé ?", "a3": "Quatre modèles tournent en parallèle — Poisson, Dixon-Coles, Monte Carlo, Elo et Shin. Le marché retenu est celui où leurs probabilités convergent et s’écartent le plus du prix des bookmakers.", "q4": "Que se passe-t-il quand les données ne suffisent pas ?", "a4": "Aucun signal n’est publié sur ce match. C’est affiché explicitement plutôt que remplacé par un pari de remplissage.", "q5": "Quels championnats sont couverts ?", "a5": "Quinze compétitions, dont la Ligue 1, la Premier League, la Liga, la Serie A, la Bundesliga, la Champions League, la Liga MX et la Premier Soccer League. La liste complète défile en haut de cette page.", "q7": "À quelle fréquence les analyses sont-elles mises à jour ?", "a7": "Chaque jour, avant le coup d’envoi des matchs. Une analyse publiée n’est jamais réécrite après coup.", "cCta1": "mc-cta\">Voir l\\'analyse complète<", "cCta2": "Débloquer avec Pro", "cFree": "mc-badge-free\">Analyse gratuite</span>", "cConf": "CONFIANCE", "cLockSr": "Réservé aux membres Pro"}, "en": {"t2": "Find the right market ", "t3": "that's fair.", "cta1": "See today's free analysis", "cta2": "See a sample analysis", "price": "Try it free · Pro at €19.95 a month, no commitment", "decSub": "Today's matches where the model and the market disagree enough to matter.", "b1t": "text-ink\">The signal</h3>", "b1d": "The market where the model finds the widest gap against the bookmakers' price.", "b2t": "The reasoning", "b2d": "The data and factors that led the model there, written in plain words.", "b3t": "The uncertainty", "b3d": "When the data isn't solid enough, no signal is published. We say it, we don't hide it.", "kpiEye": "WHAT THE ENGINE HAS PROCESSED", "kpi1": "Analyses published", "kpi3": "Models cross-checked", "kpi4": "Matches analysed today", "trLead": "A model that finds a signal in every match isn't finding signals — it's manufacturing them.", "acc3": "when you want to see everything.", "pfName": "text-soft\">Free</h3>", "pfDesc": "To judge the product for yourself: free account, no card required.", "pfCta": "[0.05]\">Get started</a>", "ff1": "Today's free analysis, in full, with a free account", "ff2": "Identified market and confidence level", "ff3": "Detailed explanation of the signal", "pMonth": "/month", "pNote": "No commitment · cancel in one click", "pCta": "Unlock Pro", "pPlus": "Everything in Free, plus:", "mTitle3": "per match.", "mLead": "Each model answers a different question. A signal only comes out where their answers converge.", "m1d": "Distribution of expected goals for each team.", "m2d": "Correction of the low scorelines pure Poisson underestimates.", "m3d": "Thousands of simulations for a robust distribution.", "m4d": "True strength over time, and removal of the odds bias.", "sigT": "IASHARK signal", "sigD": "One priority market, one probability, and the measured gap against the market price.", "s1d": "Fixtures, likely line-ups, head-to-heads and xG statistics, competition by competition.", "s2t": "The models compute", "s2d": "Poisson, Dixon-Coles and Monte Carlo run in parallel on every market.", "s3d": "One clear sheet: probability, reliability, and the gap found against the real market.", "q2": "Does IASHARK guarantee winnings?", "a2": "No, and nobody can. The model looks for markets where the computed probability diverges from the market's. It is a method, not a guarantee.", "q3": "How is the signal computed?", "a3": "Four models run in parallel — Poisson, Dixon-Coles, Monte Carlo, Elo and Shin. The chosen market is the one where their probabilities converge and diverge most from the bookmakers' price.", "q4": "What happens when the data isn't enough?", "a4": "No signal is published for that match. It is stated explicitly rather than replaced by a filler bet.", "q5": "Which competitions are covered?", "a5": "Fifteen competitions, including Ligue 1, the Premier League, La Liga, Serie A, the Bundesliga, the Champions League, Liga MX and the Premier Soccer League. The full list scrolls at the top of this page.", "q7": "How often are the analyses updated?", "a7": "Every day, before kick-off. A published analysis is never rewritten afterwards.", "cCta1": "mc-cta\">See the full analysis<", "cCta2": "Unlock with Pro", "cFree": "mc-badge-free\">Free analysis</span>", "cConf": "CONFIDENCE", "cLockSr": "Reserved for Pro members"}, "es": {"t2": "Encuentra el mercado ", "t3": "justo.", "cta1": "Ver el análisis gratuito del día", "cta2": "Ver un ejemplo de análisis", "price": "Prueba gratis · Pro a 19,95 € al mes, sin compromiso", "decSub": "Los partidos que hoy presentan una diferencia aprovechable entre el modelo y el mercado.", "b1t": "text-ink\">La señal</h3>", "b1d": "El mercado donde el modelo detecta la mayor diferencia con el precio de las casas.", "b2t": "La explicación", "b2d": "Los datos y factores que llevaron al modelo a esa conclusión, en lenguaje claro.", "b3t": "La incertidumbre", "b3d": "Cuando los datos no son bastante sólidos, no se publica ninguna señal. Se dice, no se oculta.", "kpiEye": "LO QUE EL MOTOR YA HA PROCESADO", "kpi1": "Análisis publicados", "kpi3": "Modelos cruzados", "kpi4": "Partidos analizados hoy", "trLead": "Un modelo que encuentra señal en todos los partidos no busca señales: las fabrica.", "acc3": "cuando quieras verlo todo.", "pfName": "text-soft\">Gratis</h3>", "pfDesc": "Para juzgar el producto por ti mismo: cuenta gratuita, sin tarjeta.", "pfCta": "[0.05]\">Empezar</a>", "ff1": "Análisis gratuito del día, completo, con una cuenta gratuita", "ff2": "Mercado identificado y nivel de confianza", "ff3": "Explicación detallada de la señal", "pMonth": "/mes", "pNote": "Sin compromiso · cancela en un clic", "pCta": "Desbloquear Pro", "pPlus": "Todo el plan Gratis, más:", "mTitle3": "por partido.", "mLead": "Cada modelo responde a una pregunta distinta. La señal solo sale donde sus respuestas convergen.", "m1d": "Distribución de los goles esperados de cada equipo.", "m2d": "Corrección de los marcadores bajos que el Poisson puro subestima.", "m3d": "Miles de simulaciones para una distribución robusta.", "m4d": "Fuerza real en el tiempo, y eliminación del sesgo de las cuotas.", "sigT": "Señal IASHARK", "sigD": "Un mercado prioritario, una probabilidad y la diferencia medida con el precio del mercado.", "s1d": "Calendarios, alineaciones probables, enfrentamientos y estadísticas xG, competición a competición.", "s2t": "Los modelos calculan", "s2d": "Poisson, Dixon-Coles y Monte Carlo corren en paralelo sobre cada mercado.", "s3d": "Una ficha clara: probabilidad, fiabilidad y la diferencia detectada con el mercado real.", "q2": "¿IASHARK garantiza ganancias?", "a2": "No, y nadie puede. El modelo busca mercados donde la probabilidad calculada se aparta de la del mercado. Es un método, no una garantía.", "q3": "¿Cómo se calcula la señal?", "a3": "Cuatro modelos corren en paralelo — Poisson, Dixon-Coles, Monte Carlo, Elo y Shin. El mercado elegido es aquel donde sus probabilidades convergen y más se apartan del precio de las casas.", "q4": "¿Qué pasa cuando los datos no bastan?", "a4": "No se publica ninguna señal para ese partido. Se indica explícitamente en vez de sustituirlo por una apuesta de relleno.", "q5": "¿Qué competiciones están cubiertas?", "a5": "Quince competiciones, entre ellas la Ligue 1, la Premier League, La Liga, la Serie A, la Bundesliga, la Champions League, la Liga MX y la Premier Soccer League. La lista completa se desplaza arriba en esta página.", "q7": "¿Con qué frecuencia se actualizan los análisis?", "a7": "Cada día, antes del inicio. Un análisis publicado nunca se reescribe después.", "cCta1": "mc-cta\">Ver el análisis completo<", "cCta2": "Desbloquear con Pro", "cFree": "mc-badge-free\">Análisis gratuito</span>", "cConf": "CONFIANZA", "cLockSr": "Reservado a los miembros Pro"}, "de": {"t2": "Finde den richtigen Markt ", "t3": ".", "cta1": "Die heutige Gratis-Analyse ansehen", "cta2": "Beispielanalyse ansehen", "price": "Gratis testen · Pro für 19,95 € im Monat, ohne Bindung", "decSub": "Die heutigen Spiele mit einer nutzbaren Abweichung zwischen Modell und Markt.", "b1t": "text-ink\">Das Signal</h3>", "b1d": "Der Markt, bei dem das Modell die größte Abweichung zum Buchmacherpreis findet.", "b2t": "Die Begründung", "b2d": "Die Daten und Faktoren, die das Modell dorthin geführt haben, klar formuliert.", "b3t": "Die Unsicherheit", "b3d": "Wenn die Daten nicht belastbar sind, wird kein Signal veröffentlicht. Das steht da, es wird nicht versteckt.", "kpiEye": "WAS DIE ENGINE BEREITS VERARBEITET HAT", "kpi1": "Veröffentlichte Analysen", "kpi3": "Gekreuzte Modelle", "kpi4": "Heute analysierte Spiele", "trLead": "Ein Modell, das in jedem Spiel ein Signal findet, sucht keines — es erfindet eines.", "acc3": "wenn du alles sehen willst.", "pfName": "text-soft\">Gratis</h3>", "pfDesc": "Um das Produkt selbst zu beurteilen: kostenloses Konto, ohne Karte.", "pfCta": "[0.05]\">Starten</a>", "ff1": "Die heutige Gratis-Analyse, vollständig, mit kostenlosem Konto", "ff2": "Identifizierter Markt und Konfidenzwert", "ff3": "Detaillierte Erklärung des Signals", "pMonth": "/Monat", "pNote": "Ohne Bindung · Kündigung mit einem Klick", "pCta": "Pro freischalten", "pPlus": "Alles aus Gratis, plus:", "mTitle3": "pro Spiel.", "mLead": "Jedes Modell beantwortet eine andere Frage. Ein Signal entsteht nur dort, wo ihre Antworten übereinstimmen.", "m1d": "Verteilung der erwarteten Tore je Team.", "m2d": "Korrektur der niedrigen Ergebnisse, die reines Poisson unterschätzt.", "m3d": "Tausende Simulationen für eine robuste Verteilung.", "m4d": "Echte Stärke über die Zeit und Entfernung des Quoten-Bias.", "sigT": "IASHARK-Signal", "sigD": "Ein vorrangiger Markt, eine Wahrscheinlichkeit und die gemessene Abweichung zum Marktpreis.", "s1d": "Spielpläne, wahrscheinliche Aufstellungen, Direktvergleiche und xG-Statistiken, Wettbewerb für Wettbewerb.", "s2t": "Die Modelle rechnen", "s2d": "Poisson, Dixon-Coles und Monte Carlo laufen parallel über jeden Markt.", "s3d": "Ein klares Blatt: Wahrscheinlichkeit, Verlässlichkeit und die Abweichung zum echten Markt.", "q2": "Garantiert IASHARK Gewinne?", "a2": "Nein, und das kann niemand. Das Modell sucht Märkte, in denen die berechnete Wahrscheinlichkeit von der des Marktes abweicht. Eine Methode, keine Garantie.", "q3": "Wie wird das Signal berechnet?", "a3": "Vier Modelle laufen parallel — Poisson, Dixon-Coles, Monte Carlo, Elo und Shin. Gewählt wird der Markt, bei dem ihre Wahrscheinlichkeiten übereinstimmen und am stärksten vom Buchmacherpreis abweichen.", "q4": "Was passiert, wenn die Daten nicht reichen?", "a4": "Für dieses Spiel wird kein Signal veröffentlicht. Das steht ausdrücklich da, statt durch eine Füllwette ersetzt zu werden.", "q5": "Welche Wettbewerbe sind abgedeckt?", "a5": "Fünfzehn Wettbewerbe, darunter Ligue 1, Premier League, La Liga, Serie A, Bundesliga, Champions League, Liga MX und Premier Soccer League. Die vollständige Liste läuft oben auf dieser Seite.", "q7": "Wie oft werden die Analysen aktualisiert?", "a7": "Täglich, vor dem Anpfiff. Eine veröffentlichte Analyse wird nachträglich nie umgeschrieben.", "cCta1": "mc-cta\">Vollständige Analyse ansehen<", "cCta2": "Mit Pro freischalten", "cFree": "mc-badge-free\">Kostenlose Analyse</span>", "cConf": "KONFIDENZ", "cLockSr": "Nur für Pro-Mitglieder"}, "it": {"t2": "Trova il mercato ", "t3": " giusto.", "cta1": "Vedi l'analisi gratuita del giorno", "cta2": "Vedi un esempio di analisi", "price": "Prova gratis · Pro a 19,95 € al mese, senza vincoli", "decSub": "Le partite che oggi mostrano uno scarto sfruttabile tra modello e mercato.", "b1t": "text-ink\">Il segnale</h3>", "b1d": "Il mercato in cui il modello trova lo scarto più ampio rispetto al prezzo dei bookmaker.", "b2t": "La spiegazione", "b2d": "I dati e i fattori che hanno portato il modello a quella conclusione, in parole chiare.", "b3t": "L'incertezza", "b3d": "Quando i dati non sono abbastanza solidi, nessun segnale viene pubblicato. È scritto, non nascosto.", "kpiEye": "COSA HA GIÀ ELABORATO IL MOTORE", "kpi1": "Analisi pubblicate", "kpi3": "Modelli incrociati", "kpi4": "Partite analizzate oggi", "trLead": "Un modello che trova un segnale in ogni partita non cerca segnali: li fabbrica.", "acc3": "quando vuoi vedere tutto.", "pfName": "text-soft\">Gratuito</h3>", "pfDesc": "Per giudicare il prodotto di persona: account gratuito, senza carta.", "pfCta": "[0.05]\">Inizia</a>", "ff1": "Analisi gratuita del giorno, completa, con un account gratuito", "ff2": "Mercato identificato e livello di fiducia", "ff3": "Spiegazione dettagliata del segnale", "pMonth": "/mese", "pNote": "Nessun vincolo · disdici con un clic", "pCta": "Sblocca Pro", "pPlus": "Tutto il piano Gratuito, più:", "mTitle3": "per partita.", "mLead": "Ogni modello risponde a una domanda diversa. Il segnale esce solo dove le risposte convergono.", "m1d": "Distribuzione dei gol attesi per ogni squadra.", "m2d": "Correzione dei punteggi bassi che il Poisson puro sottostima.", "m3d": "Migliaia di simulazioni per una distribuzione robusta.", "m4d": "Forza reale nel tempo, e rimozione del bias delle quote.", "sigT": "Segnale IASHARK", "sigD": "Un mercato prioritario, una probabilità e lo scarto misurato col prezzo di mercato.", "s1d": "Calendari, formazioni probabili, precedenti e statistiche xG, competizione per competizione.", "s2t": "I modelli calcolano", "s2d": "Poisson, Dixon-Coles e Monte Carlo girano in parallelo su ogni mercato.", "s3d": "Una scheda chiara: probabilità, affidabilità e lo scarto rilevato col mercato reale.", "q2": "IASHARK garantisce vincite?", "a2": "No, e nessuno può farlo. Il modello cerca i mercati in cui la probabilità calcolata si discosta da quella del mercato. È un metodo, non una garanzia.", "q3": "Come viene calcolato il segnale?", "a3": "Quattro modelli girano in parallelo — Poisson, Dixon-Coles, Monte Carlo, Elo e Shin. Il mercato scelto è quello in cui le probabilità convergono e si discostano di più dal prezzo dei bookmaker.", "q4": "Cosa succede quando i dati non bastano?", "a4": "Nessun segnale viene pubblicato per quella partita. È indicato esplicitamente invece di essere sostituito da una scommessa di riempimento.", "q5": "Quali competizioni sono coperte?", "a5": "Quindici competizioni, tra cui Ligue 1, Premier League, La Liga, Serie A, Bundesliga, Champions League, Liga MX e Premier Soccer League. L'elenco completo scorre in cima a questa pagina.", "q7": "Con quale frequenza vengono aggiornate le analisi?", "a7": "Ogni giorno, prima del fischio d'inizio. Un'analisi pubblicata non viene mai riscritta dopo.", "cCta1": "mc-cta\">Vedi l\\'analisi completa<", "cCta2": "Sblocca con Pro", "cFree": "mc-badge-free\">Analisi gratuita</span>", "cConf": "FIDUCIA", "cLockSr": "Riservato ai membri Pro"}, "pt": {"t2": "Encontra o mercado ", "t3": " certo.", "cta1": "Ver a análise grátis do dia", "cta2": "Ver um exemplo de análise", "price": "Experimenta grátis · Pro a 19,95 € por mês, sem compromisso", "decSub": "Os jogos que hoje apresentam uma diferença aproveitável entre o modelo e o mercado.", "b1t": "text-ink\">O sinal</h3>", "b1d": "O mercado onde o modelo deteta a maior diferença face ao preço das casas.", "b2t": "A explicação", "b2d": "Os dados e fatores que levaram o modelo a essa conclusão, em linguagem clara.", "b3t": "A incerteza", "b3d": "Quando os dados não são suficientemente sólidos, nenhum sinal é publicado. Está escrito, não escondido.", "kpiEye": "O QUE O MOTOR JÁ PROCESSOU", "kpi1": "Análises publicadas", "kpi3": "Modelos cruzados", "kpi4": "Jogos analisados hoje", "trLead": "Um modelo que encontra sinal em todos os jogos não procura sinais: fabrica-os.", "acc3": "quando quiseres ver tudo.", "pfName": "text-soft\">Grátis</h3>", "pfDesc": "Para julgares o produto por ti: conta gratuita, sem cartão.", "pfCta": "[0.05]\">Começar</a>", "ff1": "Análise grátis do dia, completa, com uma conta gratuita", "ff2": "Mercado identificado e nível de confiança", "ff3": "Explicação detalhada do sinal", "pMonth": "/mês", "pNote": "Sem compromisso · cancela num clique", "pCta": "Desbloquear Pro", "pPlus": "Tudo do plano Grátis, mais:", "mTitle3": "por jogo.", "mLead": "Cada modelo responde a uma pergunta diferente. O sinal só sai onde as respostas convergem.", "m1d": "Distribuição dos golos esperados de cada equipa.", "m2d": "Correção dos resultados baixos que o Poisson puro subestima.", "m3d": "Milhares de simulações para uma distribuição robusta.", "m4d": "Força real ao longo do tempo, e remoção do viés das odds.", "sigT": "Sinal IASHARK", "sigD": "Um mercado prioritário, uma probabilidade e a diferença medida face ao preço de mercado.", "s1d": "Calendários, onzes prováveis, confrontos e estatísticas xG, competição a competição.", "s2t": "Os modelos calculam", "s2d": "Poisson, Dixon-Coles e Monte Carlo correm em paralelo sobre cada mercado.", "s3d": "Uma ficha clara: probabilidade, fiabilidade e a diferença detetada face ao mercado real.", "q2": "A IASHARK garante ganhos?", "a2": "Não, e ninguém pode. O modelo procura mercados onde a probabilidade calculada se afasta da do mercado. É um método, não uma garantia.", "q3": "Como é calculado o sinal?", "a3": "Quatro modelos correm em paralelo — Poisson, Dixon-Coles, Monte Carlo, Elo e Shin. O mercado escolhido é aquele onde as probabilidades convergem e mais se afastam do preço das casas.", "q4": "O que acontece quando os dados não chegam?", "a4": "Nenhum sinal é publicado para esse jogo. É indicado explicitamente em vez de ser substituído por uma aposta de enchimento.", "q5": "Que competições estão cobertas?", "a5": "Quinze competições, incluindo a Ligue 1, a Premier League, La Liga, a Serie A, a Bundesliga, a Champions League, a Liga MX e a Premier Soccer League. A lista completa passa no topo desta página.", "q7": "Com que frequência são atualizadas as análises?", "a7": "Todos os dias, antes do apito inicial. Uma análise publicada nunca é reescrita depois.", "cCta1": "mc-cta\">Ver a análise completa<", "cCta2": "Desbloquear com Pro", "cFree": "mc-badge-free\">Análise gratuita</span>", "cConf": "CONFIANÇA", "cLockSr": "Reservado aos membros Pro"}};
...
var PAGES = [
  {
    ...
    replacements: [
      ...
      {find:
        ...
        '    <div>Aide : <a data-market-helpline="url" href="https://www.joueurs-info-service.fr" style="color:rgba(34,211,238,0.4);text-decoration:none;">joueurs-info-service.fr</a><span data-market-helpline-if="phone"> · <span data-market-helpline="phone">09 74 75 13 13</span></span></div>',
       build: function(d){
        var f = d.footer;
        return "    <div>⚠️ " + f.disclaimer_warning + "</div>\n" +
          "    <div>" + f.disclaimer_help_label + ' <a data-market-helpline="url" href="https://www.joueurs-info-service.fr" style="color:rgba(34,211,238,0.4);text-decoration:none;">' + f.disclaimer_help_site + "</a><span data-market-helpline-if=\"phone\"> · <span data-market-helpline=\"phone\">" + f.disclaimer_help_phone + "</span></span></div>";
      }},
  ...
  },
  {
    ...
    replacements: [
      ...
      {find: "15 COMPÉTITIONS COUVERTES", build: function(d,l){ return HOME_V3[l].railLbl; }},
      ...
      {find: "Une analyse n’est jamais réécrite après le match", build: function(d,l){ return HOME_V3[l].t3t; }},
      {find: "Elle est publiée avant le coup d’envoi et reste telle quelle, résultat ou pas.", build: function(d,l){ return HOME_V3[l].t3d; }},
      {find: "Aucun signal forcé", build: function(d,l){ return HOME_V3[l].t4t; }},
      {find: "Quand aucun marché ne franchit nos seuils, on l’écrit plutôt que d’inventer un pari.", build: function(d,l){ return HOME_V3[l].t4d; }},
      ...
      {find: "Oui. Une analyse complète est offerte chaque jour avec un compte gratuit, sans carte bancaire. Tu vois exactement ce que reçoit un abonné.", build: function(d,l){ return HOME_V3[l].a1; }},
      {find: "Je peux résilier quand je veux ?", build: function(d,l){ return HOME_V3[l].q3; }},
      {find: "Oui, en un clic depuis ton compte. Sans engagement, sans préavis, sans justification.", build: function(d,l){ return HOME_V3[l].a3; }},
      {find: "Identifiez le marché ", build: function(d,l){ return HOME_V4[l].t2; }},
      {find: "juste.", build: function(d,l){ return HOME_V4[l].t3; }},
      ...
      {find: "Quand les données ne sont pas assez solides, aucun signal n’est publié. C’est écrit, pas caché.", build: function(d,l){ return HOME_V4[l].b3d; }},
      ...
      {find: "Modèles croisés", build: function(d,l){ return HOME_V4[l].kpi3; }},
      {find: "Matchs analysés aujourd’hui", build: function(d,l){ return HOME_V4[l].kpi4; }},
      {find: "Un modèle qui trouve un signal sur tous les matchs ne cherche pas un signal : il en fabrique un.", build: function(d,l){ return HOME_V4[l].trLead; }},
      ...
      {find: "Marché identifié et niveau de confiance", build: function(d,l){ return HOME_V4[l].ff2; }},
      ...
      {find: "Sans engagement · résiliable en un clic", build: function(d,l){ return HOME_V4[l].pNote; }},
      ...
      {find: "Chaque modèle répond à une question différente. Le signal ne sort que là où leurs réponses convergent.", build: function(d,l){ return HOME_V4[l].mLead; }},
      {find: "Distribution du nombre de buts attendus pour chaque équipe.", build: function(d,l){ return HOME_V4[l].m1d; }},
      {find: "Correction des scores faibles que le Poisson pur sous-estime.", build: function(d,l){ return HOME_V4[l].m2d; }},
      {find: "Des milliers de simulations pour une distribution robuste.", build: function(d,l){ return HOME_V4[l].m3d; }},
      {find: "Force réelle dans le temps, et retrait du biais des cotes.", build: function(d,l){ return HOME_V4[l].m4d; }},
      ...
      {find: "Calendriers, compositions probables, confrontations et statistiques xG, championnat par championnat.", build: function(d,l){ return HOME_V4[l].s1d; }},
      {find: "Les modèles calculent", build: function(d,l){ return HOME_V4[l].s2t; }},
      {find: "Poisson, Dixon-Coles et Monte Carlo tournent en parallèle sur chaque marché.", build: function(d,l){ return HOME_V4[l].s2d; }},
      ...
      {find: "Non, et personne ne le peut. Le modèle cherche les marchés où la probabilité calculée s’écarte de celle du marché. C’est une méthode, pas une garantie.", build: function(d,l){ return HOME_V4[l].a2; }},
      {find: "Comment le signal est-il calculé ?", build: function(d,l){ return HOME_V4[l].q3; }},
      {find: "Quatre modèles tournent en parallèle — Poisson, Dixon-Coles, Monte Carlo, Elo et Shin. Le marché retenu est celui où leurs probabilités convergent et s’écartent le plus du prix des bookmakers.", build: function(d,l){ return HOME_V4[l].a3; }},
      ...
      {find: "Quinze compétitions, dont la Ligue 1, la Premier League, la Liga, la Serie A, la Bundesliga, la Champions League, la Liga MX et la Premier Soccer League. La liste complète défile en haut de cette page.", build: function(d,l){ return HOME_V4[l].a5; }},
      ...
      {find: "CONFIANCE", build: function(d,l){ return HOME_V4[l].cConf; }},
      ...
      {find: '15 compétitions</b> · analyse publiée avant le coup d\'envoi', build: function(d,l){ var h=HOME_V2[l]; return h.badgeLeagues + '</b> · ' + h.badgeRest; }},
      ...
      {find: 'Quatre modèles, ', build: function(d){ return d.landing_page.title_method_pre; }},
      ...
      {find: 'Filtres avancés et niveau de fiabilité détaillé', build: function(d){ return d.landing_page.plan_pro_feat2; }},
      {find: 'Les outils Pro : scanner de value, combiné, simulateur', build: function(d,l){ return HOME_V2[l].proFeatTools; }},
  ...
  },
  {
    ...
    replacements: [
      ...
      {find: 'Toutes les analyses, tous les championnats', build: function(d){ return d.landing_page.plan_pro_feat1; }},
      {find: 'Filtres avancés et niveau de fiabilité détaillé', build: function(d){ return d.landing_page.plan_pro_feat2; }},
      {find: 'Suivi personnel de tes matchs suivis', build: function(d){ return d.landing_page.plan_pro_feat3; }},
      {find: 'Résiliable à tout moment', build: function(d){ return d.landing_page.plan_pro_feat4; }},

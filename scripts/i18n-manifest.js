...
var PAGES = [
  ...
  },
  {
    ...
    replacements: [
      ...
      {find: "Le signal", build: function(d,l){ return HOME_V3[l].c1t; }},
      {find: "Le marché retenu, sa probabilité selon le modèle, celle du marché, et l’écart entre les deux — affiché même quand il est défavorable.", build: function(d,l){ return HOME_V3[l].c1d; }},
      {find: "Notre lecture du match", build: function(d,l){ return HOME_V3[l].c2t; }},
      {find: "Ce que le modèle a vu, écrit en français, avec le facteur qui a fait pencher la décision.", build: function(d,l){ return HOME_V3[l].c2d; }},
      {find: "Ce que dit le modèle", build: function(d,l){ return HOME_V3[l].c3t; }},
      {find: "Buts attendus par équipe et scores les plus probables, en clair.", build: function(d,l){ return HOME_V3[l].c3d; }},
      {find: "Comparatif des deux équipes", build: function(d,l){ return HOME_V3[l].c4t; }},
      {find: "Tirs, tirs cadrés, possession, corners — avec les lignes qui pèsent sur le marché recommandé mises en avant.", build: function(d,l){ return HOME_V3[l].c4d; }},
      {find: "Scénario probable", build: function(d,l){ return HOME_V3[l].c5t; }},
      {find: "La probabilité de but tranche de 15 minutes par tranche de 15 minutes.", build: function(d,l){ return HOME_V3[l].c5d; }},
      {find: "Les limites", build: function(d,l){ return HOME_V3[l].c6t; }},
      {find: "Les stats à ne pas surinterpréter, et ce que la donnée ne permet pas d’affirmer.", build: function(d,l){ return HOME_V3[l].c6d; }},
      ...
      {find: "Je vais gagner de l’argent ?", build: function(d,l){ return HOME_V3[l].q2; }},
      {find: "Personne ne peut te le promettre, et on ne le fera pas. Le modèle cherche les marchés où la probabilité calculée s’écarte de celle du marché. C’est une méthode, pas une garantie.", build: function(d,l){ return HOME_V3[l].a2; }},
      ...
      {find: "D’où viennent les données ?", build: function(d,l){ return HOME_V3[l].q4; }},
      {find: "Des données officielles de match : compositions, historiques de confrontation, statistiques de tirs et de buts attendus, et les cotes réelles des bookmakers.", build: function(d,l){ return HOME_V3[l].a4; }},
      {find: "Combien de matchs par jour ?", build: function(d,l){ return HOME_V3[l].q5; }},
      {find: "Tous les matchs des 13 championnats couverts. Le nombre varie selon le calendrier — tu vois la liste complète du jour sur cette page.", build: function(d,l){ return HOME_V3[l].a5; }},
      {find: 'Comprenez le match.<br>', build: function(d,l){ return HOME_V2[l].title1 + '<br>'; }},
      {find: 'Identifiez le marché juste.', build: function(d,l){ return HOME_V2[l].title2; }},
      ...
      {find: 'Modèles statistiques', build: function(d,l){ return HOME_V2[l].statModels; }},
      {find: 'Analyse offerte par jour', build: function(d,l){ return HOME_V2[l].statFree; }},
      {find: '/mois', count: 2, build: function(d,l){ return HOME_V2[l].priceMonth; }},
      {find: 'Sans engagement · résiliable en un clic', count: 2, build: function(d,l){ return HOME_V2[l].priceNote; }},
      {find: 'VOIR LE MATCH GRATUIT DU JOUR', build: function(d){ return d.landing_page.hero_cta; }},
      ...
      {find: '</b> par match.', build: function(d){ return '</b>' + d.landing_page.title_method_post; }},
      
      {find: '>MODÈLE 1<', build: function(d){ return '>' + d.landing_page.model1_tag + '<'; }},
      {find: '>MODÈLE 2<', build: function(d){ return '>' + d.landing_page.model2_tag + '<'; }},
      {find: '>MODÈLE 3<', build: function(d){ return '>' + d.landing_page.model3_tag + '<'; }},
      {find: '>MODÈLE 4<', build: function(d){ return '>' + d.landing_page.model4_tag + '<'; }},
      {find: "Distribution du nombre de buts attendus pour chaque équipe, à domicile et à l'extérieur.", build: function(d){ return d.landing_page.model1_desc; }},
      {find: 'Correction des scores faibles (0-0, 1-0, 1-1) que le Poisson pur sous-estime.', build: function(d){ return d.landing_page.model2_desc; }},
      {find: 'Des milliers de simulations du match pour obtenir une distribution de résultats robuste.', build: function(d){ return d.landing_page.model3_desc; }},
      {find: 'Force réelle des équipes dans le temps, et correction du biais des probabilités implicites.', build: function(d){ return d.landing_page.model4_desc; }},
      ...
      {find: '>Le modèle calcule<', build: function(d){ return '>' + d.landing_page.step2_title + '<'; }},
      {find: '>Tu reçois le signal<', build: function(d){ return '>' + d.landing_page.step3_title + '<'; }},
      {find: 'Calendriers, compositions probables, historique des confrontations et statistiques xG remontés en continu, championnat par championnat.', build: function(d){ return d.landing_page.step1_desc; }},
      {find: 'Poisson, Dixon-Coles et Monte Carlo tournent en parallèle pour produire une distribution de probabilités sur chaque marché.', build: function(d){ return d.landing_page.step2_desc; }},
      {find: 'Une fiche claire par match : probabilité, niveau de fiabilité, et le marché où le modèle détecte un écart avec le marché réel.', build: function(d){ return d.landing_page.step3_desc; }},
      ...
      {find: '</b> quand tu veux tout voir.', build: function(d){ return '</b>' + d.landing_page.title_access_post; }},
      
      {find: '>GRATUIT<', build: function(d){ return '>' + d.landing_page.plan_free_name + '<'; }},
      ...
      {find: 'Tous les matchs du jour visibles', build: function(d,l){ return HOME_V2[l].freeFeatAll; }},
      ...
      {find: '>COMMENCER<', build: function(d){ return '>' + d.landing_page.plan_free_cta + '<'; }},
      
      {find: '>DÉBLOQUER PRO<', build: function(d){ return '>' + d.landing_page.plan_pro_cta + '<'; }},
      ...
      {find: '>VOIR LE MATCH DU JOUR<', build: function(d){ return '>' + d.landing_page.final_cta + '<'; }},
      ...
      {find: '<span class="mc-pari-bet">Analyse réservée aux membres Pro</span>', build: function(d,l){ var text={fr:'Analyse réservée aux membres Pro',en:'Analysis reserved for Pro members',es:'Análisis reservado para miembros Pro',de:'Analyse für Pro-Mitglieder reserviert',it:'Analisi riservata ai membri Pro',pt:'Análise reservada aos membros Pro'}; return '<span class="mc-pari-bet">' + text[l] + '</span>'; }},
      {find: '<span class="mc-cta mc-cta-locked">Deviens Pro →</span>', build: function(d,l){ var text={fr:'Deviens Pro →',en:'Go Pro →',es:'Hazte Pro →',de:'Pro werden →',it:'Passa a Pro →',pt:'Torna-te Pro →'}; return '<span class="mc-cta mc-cta-locked">' + text[l] + '</span>'; }},

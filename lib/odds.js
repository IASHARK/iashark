    ...
    (bk.bets || []).forEach((bet) => {
      ...
      if (bet.name === "Goals Over/Under") {
        (bet.values || []).forEach((v) => {
          if (v.value === "Over 1.5") record(bk, "goals_ou", "over_1.5", v.odd);
          if (v.value === "Over 2.5") record(bk, "goals_ou", "over_2.5", v.odd);
          if (v.value === "Under 2.5") record(bk, "goals_ou", "under_2.5", v.odd);
          if (v.value === "Over 3.5") record(bk, "goals_ou", "over_3.5", v.odd);
          if (v.value === "Under 3.5") record(bk, "goals_ou", "under_3.5", v.odd);
        });
      }
      ...
      if (bet.name === "Total - Home" || bet.name === "Home Team Total Goals") {
        (bet.values || []).forEach((v) => {
          if (v.value === "Over 1.5") record(bk, "home_over15", "yes", v.odd, { min: 1.05, max: 100 });
          if (v.value === "Under 1.5") record(bk, "home_under15", "yes", v.odd, { min: 1.05, max: 100 });
        });
      }
      // Meme bug que ci-dessus : "Total - Away", jamais "Away Team Total Goals".
      if (bet.name === "Total - Away" || bet.name === "Away Team Total Goals") {
        (bet.values || []).forEach((v) => {
          if (v.value === "Over 1.5") record(bk, "away_over15", "yes", v.odd, { min: 1.05, max: 100 });
          if (v.value === "Under 1.5") record(bk, "away_under15", "yes", v.odd, { min: 1.05, max: 100 });
        });
      }

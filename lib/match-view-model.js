  ...
  function buildMatchViewModel(raw) {
    ...
    return {
      ...
      editorial: {
        ...
        // Deux faits chiffres qui justifient le marche recommande, calcules
        // par lib/insights.js a partir des moyennes reelles des deux equipes.
        marketJustifications: insights && recommendation ? insights.buildMarketJustifications({
          market: recommendation.market,
          homeName: home.name, awayName: away.name,
          statsHome: raw.match_stats_home, statsAway: raw.match_stats_away,
          eventsHome: raw.events_home, eventsAway: raw.events_away
        }) : []
      },

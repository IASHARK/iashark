// MatchPulseLyonRennesInstagram : duplique du modele maitre MatchPulseBrentfordChelseaInstagram (19/09/2026).
// Donnees reelles (iashark.com/match/1552768.json, events_home/events_away : buts marques et
// encaisses par tranche de 15 min sur les 20 derniers matchs de chaque equipe).
// share = % des 123 buts observes ; balance = part Lyon (buts Lyon + encaisses Rennes) ;
...
const PHASES: Phase[] = [
  {
    ...
    share: 15,
    level: "DANGER MODÉRÉ",
    title: "RENNES PART VITE",
    note: "8 BUTS MARQUÉS PAR RENNES DANS LE PREMIER QUART D’HEURE SUR SES 20 DERNIERS MATCHS",
    pressure: 3,
    shots: 2,
    rhythm: 4,
    balance: 44,
  },
  {
    ...
    share: 12,
    level: "RENNES TIENT",
    title: "RENNES VERROUILLE",
    note: "9 BUTS MARQUÉS ET AUCUN ENCAISSÉ PAR RENNES SUR CETTE PÉRIODE",
    pressure: 3,
    shots: 3,
    rhythm: 5,
    balance: 33,
  },
  {
    ...
    share: 17,
    level: "DANGER MODÉRÉ",
    title: "LYON REPREND LA MAIN",
    note: "RENNES A ENCAISSÉ 7 BUTS JUSTE AVANT LA PAUSE",
    pressure: 4,
    shots: 3,
    rhythm: 2,
    balance: 62,
  },
  {
    ...
    share: 22,
    level: "PIC DE DANGER",
    title: "LA REPRISE, MOMENT CLÉ",
    note: "RENNES A ENCAISSÉ 9 BUTS ENTRE LA 45E ET LA 60E",
    pressure: 5,
    shots: 4,
    rhythm: 3,
    balance: 59,
  },
  {
    label: "60–75",
    share: 15,
    level: "MATCH ÉQUILIBRÉ",
    title: "MATCH ÉQUILIBRÉ",
    note: "5 BUTS MARQUÉS PAR CHAQUE ÉQUIPE SUR CETTE PÉRIODE",
    pressure: 3,
    shots: 3,
    rhythm: 3,
    balance: 47,
  },
  {
    ...
    title: "FIN DE MATCH OUVERTE",
    note: "12 BUTS MARQUÉS PAR LYON ET RENNES DANS LE DERNIER QUART D’HEURE",
    pressure: 4,
    shots: 3,
    rhythm: 3,
    balance: 48,
...
export const MatchPulseLyonRennesInstagram = () => {
  ...
  return (
    <AbsoluteFill style={{background: "#01060a", color: "white", fontFamily: "Arial, sans-serif", overflow: "hidden"}}>
      ...
      >
        <Team name="Lyon" logo="logos/team-80.png" />
        ...
        <Team name="Rennes" logo="logos/team-94.png" />
      </div>
      ...
      >
        ...
        <Meter label="BUTS LYON" value={activePhase.shots} icon="shots" />
        <Meter label="BUTS RENNES" value={activePhase.rhythm} icon="shots" />
      </Interactive.Div>

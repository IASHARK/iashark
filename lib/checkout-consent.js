...
(function (global) {
  ...
  // fr et pages racine, francaises, en "2026-09-18").
  // 21/09/2026 : /en/ seul change (ouverture de l'hebdomadaire a 4,99 USD -
  // articles 5, 6, 7, 8 et 9 de legal/en/cgv.html ; version precedente archivee
  // dans legal/en/archives/cgv-2026-09-19.html).
  var TERMS_VERSIONS = { en: "2026-09-21" };
  ...
  var CSS = ""
    + ".iash-consent{margin:16px 0 14px;padding:12px 14px;border:1px solid rgba(141,179,211,.2);border-radius:12px;background:rgba(255,255,255,.025);text-align:left;font-family:inherit}"
    + ".iash-consent-title{margin:0 0 8px;font-size:11px;font-weight:700;letter-spacing:.14em;text-transform:uppercase;color:#a6b4c6}"
    + ".iash-consent-row{display:flex;gap:10px;align-items:flex-start;margin:0 0 8px;font-size:13px;line-height:1.5;color:#dbe4ee;cursor:pointer;text-transform:none;letter-spacing:normal}"

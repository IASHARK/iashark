...
var PAGES = [
  ...
  },
  {
    ...
    replacements: [
      ...
      {find: '<span>Confiance du modèle</span>', build: function(d,l){ return '<span>' + HOME_V2[l].modelConfidence + '</span>'; }},
      {find: '<span>Lecture IASHARK</span><strong>Prioritaire</strong>', build: function(d,l){ var h=HOME_V2[l]; return '<span>' + h.reading + '</span><strong>' + h.priority + '</strong>'; }},

...
//
// Restent publics :
//   - PUBLIC_TEASER : conf (indice 0-10), has_signal, no_signal,
//     no_signal_label, data_quality_score/label, model_output_available,
//     analysis_tier - de quoi dire "une analyse existe" sans la donner ;
...
// scripts/seo-pages.js et les tests. supabase/functions/match-data/index.ts
...
const PREMIUM_PAYLOAD_FIELDS = [
  // Probabilites et sorties chiffrees du modele.
  ...
  // Fiabilite detaillee et notes internes du moteur (au-dela de conf).
...
const NESTED_MODEL_KEYS = ["goal_threat_score", "score_components", "opponent_defense_multiplier", "baseline_conversion", "analyse_i18n"];

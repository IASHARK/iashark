...
const MARKET_REGISTRY = [
  ...
  },
  {
    ...
    resolver_function: "lib/resolvers.js#resolveMarketWin (Domicile/Exterieur clean sheet)",
    min_data_quality: "low",
    availability_status: "MODELLED_EXPERIMENTAL",
    version: "v1",
    notes: "Modele, cotes reelles API-Football (bet_id 27/28, Clean Sheet - Home/Away) et resolver desormais branches dans le pipeline de production (allMarkets). Statut experimental maintenu jusqu'au backtest chronologique, meme convention que TEAM_TOTALS.",
  },
  {

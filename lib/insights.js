...
// relance, discipline, coups de pied arretes. Chaque categorie compare
// une vraie valeur des deux equipes ; "avantage" est simplement qui a la
// meilleure valeur reelle, jamais une appreciation subjective. Score
// global = moyenne ponderee normalisee sur 10, memes poids documentes
// pour les deux equipes.
var MATCHUP_CATEGORIES = [
  { key: "attaque", label: "Attaque", higherIsBetter: true, weight: 0.3 },
  { key: "defense", label: "Défense", higherIsBetter: false, weight: 0.3 },
  { key: "possession", label: "Possession / relance", higherIsBetter: true, weight: 0.15 },
  { key: "discipline", label: "Discipline", higherIsBetter: false, weight: 0.1 },
  { key: "cpa", label: "Coups de pied arrêtés", higherIsBetter: true, weight: 0.15 }
];
function computeMatchup(statsHome, statsAway) {
  ...
  MATCHUP_CATEGORIES.forEach(function(cat){
    ...
    categories.push({ key: cat.key, label: cat.label, home: h, away: a, advantage: advantage });

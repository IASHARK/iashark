...
var PAGES = [
  ...
  },
  {
    ...
    replacements: [
      ...
      {find: "13 CHAMPIONNATS COUVERTS", build: function(d,l){ return HOME_V3[l].railLbl; }},
      ...
      {find: "Oui. Une analyse complète est offerte chaque jour, sans carte bancaire. Tu vois exactement ce que reçoit un abonné.", build: function(d,l){ return HOME_V3[l].a1; }},
      ...
      {find: "Pour juger le produit sur pièce, sans carte bancaire.", build: function(d,l){ return HOME_V4[l].pfDesc; }},
      {find: "[0.05]\">Commencer</a>", build: function(d,l){ return HOME_V4[l].pfCta; }},
      {find: "Analyse gratuite du jour, complète", build: function(d,l){ return HOME_V4[l].ff1; }},
      ...
      {find: "Treize compétitions, dont la Ligue 1, la Premier League, LaLiga, la Serie A, la Bundesliga, la Champions League et l’Europa League. La liste complète défile en haut de cette page.", build: function(d,l){ return HOME_V4[l].a5; }},
      ...
      {find: '13 championnats</b> · analyse publiée avant le coup d\'envoi', build: function(d,l){ var h=HOME_V2[l]; return h.badgeLeagues + '</b> · ' + h.badgeRest; }},
      {find: 'Championnats couverts', build: function(d,l){ return HOME_V2[l].statLeagues; }},
